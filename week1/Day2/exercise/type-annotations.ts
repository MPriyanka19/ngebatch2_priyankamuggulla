...
// - variables
 ...
 const titles:string[] = [
  ...
  const linkAuthors = (authors:string[], titles:string[], ignoreMissingTitles:boolean) => {
  ...
  type MyFunction = (firstName: string, lastName: string)=>number
